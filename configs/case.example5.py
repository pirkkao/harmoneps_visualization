...
# EXAMPLE 5
#
# Repetition of example 4, but we use the switch "masked"
# to activate functionalities that will enhance the color
# depth of small field values. This is useful if you want
# to get a more detailed idea about the mean differences.
#
#########################################################
# What to plot
